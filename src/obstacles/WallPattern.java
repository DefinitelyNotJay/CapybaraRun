...
=======
                ...
                // new WallHanging(gp, start + arr.get(20) + 64 + 64 + 64 + 64 + 64 + 64 + 52 , 100, gp.tileSize, gp.tileSize)
                // //21
                // new WallHanging(gp, start, 100, gp.tileSize, gp.tileSize),
                // new WallGround(gp, start, 342, gp.tileSize, gp.tileSize),
                // new WallHanging(gp, start + 250, 100, gp.tileSize, gp.tileSize),
                // new WallGround(gp, start + 250, 342, gp.tileSize, gp.tileSize),
                // new WallHanging(gp, start + 250 + 250, 100, gp.tileSize, gp.tileSize),
                // new WallGround(gp, start + 250 + 250, 342, gp.tileSize, gp.tileSize),
                // new WallHanging(gp, start + 250 + 250 + 250, 100, gp.tileSize, gp.tileSize),
                // new WallGround(gp, start + 250 + 250 + 250, 342, gp.tileSize, gp.tileSize)
                // // 22
                // new WallHanging(gp, start, 50, gp.tileSize, gp.tileSize),
                // new WallHanging(gp, start + 300, 50, gp.tileSize, gp.tileSize)
                // // 23
                // new WallGround(gp, start, 342, gp.tileSize, gp.tileSize),
                // new WallGround(gp, start + 400, 342, gp.tileSize, gp.tileSize)
                // // 24
                // new WallHanging(gp, start + 500, 280, gp.tileSize, gp.tileSize),
